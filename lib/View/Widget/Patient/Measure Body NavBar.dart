...
class MeasureNav extends StatefulWidget {

  final int tabIndexes;
  final int? id;

  const MeasureNav({Key? key, required this.tabIndexes, this.id});

  @override
  State<MeasureNav> createState() => _MeasureNavState();
}

class _MeasureNavState extends State<MeasureNav> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: CircleNavBar(
        activeIcons: const [
          ...
          Icon(Icons.monitor_heart_outlined, color: Colors.white, size: 35,),
         ...
         */
        inactiveIcons:  [
          Text("Temperature", style: GoogleFonts.poppins(
            color: Colors.white, fontWeight: FontWeight.bold
          ),),
          Text("Pulse", style: GoogleFonts.poppins(
              color: Colors.white, fontWeight: FontWeight.bold
          ),),
      ...
      body: PageView(
        ...
        children: [
           ...
           */
          TempMeasure(id: widget.id),
          PulseMeasure(id: widget.id)
