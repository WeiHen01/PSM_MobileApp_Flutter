...
import '../../Patient/Body Status/Heart Beat/Pulse Dashboard.dart';
import '../../Patient/Body Status/Heart Beat/Pulse History.dart';


class PulseNav extends StatefulWidget {

  final int tabIndexes;
  final int? id;

  const PulseNav({Key? key, required this.tabIndexes, this.id});

  @override
  State<PulseNav> createState() => _PulseNavState();
}

class _PulseNavState extends State<PulseNav> {
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
           ...
           */
          PulseDashboard(id: widget.id),
          PulseHistory(id: widget.id),
