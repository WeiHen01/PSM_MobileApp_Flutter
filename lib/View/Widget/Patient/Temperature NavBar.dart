...
import '../../Patient/Body Status/Temperature/Temperature Dashboard.dart';
import '../../Patient/Body Status/Temperature/Temperature History.dart';
...
class TempNav extends StatefulWidget {
  ...
  final int? id;
  const TempNav({Key? key, required this.tabIndexes, this.id});

  @override
  State<TempNav> createState() => _TempNavState();
}

class _TempNavState extends State<TempNav> {
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
           ...
           */
          TempDashboard(id: widget.id,),
          TempHistory(id: widget.id,),
        ],
      )
    );
  }
