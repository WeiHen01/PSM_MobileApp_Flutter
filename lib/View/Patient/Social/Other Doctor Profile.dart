...
class OtherDoctorProfile extends StatefulWidget {
  final int? id;
  const OtherDoctorProfile({super.key, this.id});

  @override
  State<OtherDoctorProfile> createState() => _OtherDoctorProfileState();
}

class _OtherDoctorProfileState extends State<OtherDoctorProfile> {
