...
class UserChangePassword extends StatefulWidget {
  ...
  UserChangePassword({Key? key, this.id});
...
class _UserChangePasswordState extends State<UserChangePassword> {
  ...
  Future<void> updatePassword() async{
    ...
    if (passwordCtrl.text.isNotEmpty && passwordCtrl.text != null
    && conPasswordCtrl.text.isNotEmpty && conPasswordCtrl.text != null 
    && conPasswordCtrl.text == passwordCtrl.text) {
  ...
  /* Future<void> updatePassword() async{
    ...
    && conPasswordCtrl.text != null && conPasswordCtrl.text.isNotEmpty 
    && conPasswordCtrl.text == passwordCtrl.text) {
    ...
    else
    {
     ArtSweetAlert.show(
        ...
        artDialogArgs: ArtDialogArgs(
          type: ArtSweetAlertType.danger,
          title: "UPDATE FAILURE",
          text: "Fail to update your password!",
        ),
      );
    }
  }  */
